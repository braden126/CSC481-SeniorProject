...
*How to read: The assignment module received an average of 103 views on each module posted, each student viewed an assignment module on average 7 times, and each class had an average of 10 assignment modules added*
```{r, message=FALSE, warning=FALSE, echo=FALSE}
...
Most students viewed a recorded lecture within about 5 days of a recording being posted. However another decently sized group viewed the recording lecture 13+ days after posting.
...
Most activity between 8:00 - 15:00 is due to classes occuring during that time range which brings students on to Moodle. 
...
Like in the graph above, the results from 8:00 - 15:00 are likely ot indicative of any trends since assignments turned in at that time are likely assignments in-class assignments.
