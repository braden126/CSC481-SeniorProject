...
```{r, message=FALSE, warning=FALSE, echo=FALSE}
##q41
#which min = time viewed
#time assignemnt was submitted
...
ggplot(q43, aes(x=reorder(assignmentid, timeview_submit), y = timeview_submit)) + 
  geom_point(alpha = 0.5) +
  geom_point(data = q431, aes(x=assignmentid, y = meantime, color = "red"), size = 1.5) +
...
## how many times was status of submission viewed
